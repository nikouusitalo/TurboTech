        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                                      <p class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Trusted Worldwide with Over 5 Million Users. Got Questions? Let’s Chat!</p>
...
<?php wp_footer(); // Hook for plugins to add code just before </body> ?>
